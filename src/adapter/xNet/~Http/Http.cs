...
        /// <param name =“dont Escape”>指定是否对参数值进行编码。</ param>
        /// <returns>请求字符串。</ returns>
        /// <exception cref =“System.Argument Null Exception”> <paramref name =“parameters”/>参数的值是<see langword =“null”/>.</ exception>
...
        /// <param name =“parameters”>参数。</ param>
        /// <param name =“dont Escape”>指定是否对参数值进行编码。</ param>
        /// <param name =“encoding”>用于转换请求参数的编码。如果参数的值是<see langword =“null”/>，那么将使用该值<see cref =“System.Text.Encoding.UTF8”/>.</ param>
        /// <returns>请求字符串。</ returns>
        /// <exception cref =“System.Argument Null Exception”> <paramref name =“parameters”/>参数的值是<see langword =“null”/>.</ exception>
        ...
        /// <summary>
        ///从IE浏览器生成随机User-Agent。
        /// </summary>
        /// <returns>来自IE浏览器的随机用户代理。</returns>
        ...
        ///从Opera浏览器生成随机用户代理。
        /// </summary>
        /// <returns>Opera浏览器中的随机用户代理。</returns>
        ...
        /// 从Chrome浏览器生成随机用户代理。
        /// </summary>
        /// <returns>来自Chrome浏览器的随机用户代理.</returns>
        ...
        /// <summary>
        /// 从Firefox浏览器生成随机User-Agent。
        /// </summary>
        /// <returns>来自Firefox浏览器的随机用户代理。</returns>
        ...
        /// <summary>
        /// 从Opera的移动浏览器生成随机用户代理。
        /// </summary>
        /// <returns>Opera移动浏览器中的随机用户代理.</returns>
